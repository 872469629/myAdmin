...
<!--                     {/if} -->
                ...
                <div class="ibox-content">
                    <ul class="fui-cell-group">
                        <li class="fui-cell">商城名称：<span class="text">${shopName!''}</span></li>
                        <li class="fui-cell">商城介绍：<span class="text">${description!''}</span></li>
                        <li class="fui-cell">使用应用：<span class='text-no'>${pluginnum!''}</span>个 <a href="#" class="text-primary">查看</a></li>
                    </ul>
                </div>
            </div>
        </div>
                        ...
                        <li class="fui-list">
                            <a href="#">
                                ...
                                <div class="fui-list-inner">
                                    ...
                                    <p><#if is_openmerch?? && is_openmerch==1>自营</#if>待发货订单</p>
                                </div>
                            </a>
                        </li>
<!--                         {/if} -->
                        ...
                        <li class="fui-list">
                            <a href="#">
                                ...
                                <div class="fui-list-inner">
                                    ...
                                    <p><#if is_openmerch?? && is_openmerch==1>自营</#if>维权中订单</p>
                                </div>
                            </a>
                        </li>
<!--                         {/if} -->
...
<script type="text/javascript">
    myrequire(['echarts'], function () {
        ...
        $.ajax({
            type: "GET",
            url: "/admin/order/list/ajaxGettotals",
            dataType: "json",
        ...
        $.ajax({
            type: "GET",
            //   async: false,
            url: "/admin/order/ajaxTransaction",
            dataType: "json",
    ...
    function get_order(day) {
        $.ajax({
            type: "GET",
            url: "/admin/order/ajaxOrder?day="+day,
            dataType: "json",
            success: function (data) {
    ...
    function get_goods(day) {
        ...
        $.ajax({
            type: "GET",
            url: "/admin/order/ajaxGoods?day="+day,
            dataType: "json",
            success: function (data) {
