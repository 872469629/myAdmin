...
public class DateUtils {
    ...
    public static void main(String args[]) throws ParseException {
        ...
        Date start = sdf.parse("2018-6-15");
        getBetweenDates(start, new Date()).stream().forEach(date -> System.out.println(com.jeesuite.common.util.DateUtils.format2DateStr(date)));
    }
