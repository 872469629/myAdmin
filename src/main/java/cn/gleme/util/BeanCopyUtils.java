            ...
            for (String key : keys) {
                try {
                    ...
                    if (writeMethod != null) {
                        ...
                        if (value != null) {
//                            if(value.getClass() != destDescriptor.getPropertyType()){
                            if(!isSimpleDataType(value) && (destDescriptor.getPropertyType().getSimpleName().endsWith("DTO") || value.getClass().getSimpleName().endsWith("DTO"))){
                                value = com.jeesuite.common.util.BeanCopyUtils.copy(value, destDescriptor.getPropertyType());
                            }
    ...
    public static void zeroWrapPropertiesToNull(Object bean, String... excludeFields) throws BeanConverterException {
        try {
            ...
            if (excludeFields != null && excludeFields.length > 0 && StringUtils.isNotEmpty(excludeFields[0])) {
