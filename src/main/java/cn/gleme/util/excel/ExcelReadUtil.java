...
public class ExcelReadUtil {
	...
	public static void main(String[] args) {
		ExcelReadUtil eu = new ExcelReadUtil();
	 ...
	 * @return
	 */
	public ExcelReadUtil RestoreSettings(){
		ExcelReadUtil instance = new  ExcelReadUtil(this.excelPath);
		return instance;
	}
	...
	public void testMerge(){
		try {
			ExcelReadUtil eu1 = new ExcelReadUtil();//用来读取源xls
			ExcelReadUtil eu2 = new ExcelReadUtil();//用来读取目标xls，用于演示合并结果
