...
public class Message {
	...
	/** 跳转URL */
	private String retUrl = "list.jhtml";
	 ...
	 *            参数
	 */
	public Message(Message.Type type, String content,String retUrl, Object... args) {
		this.type = type;
		this.retUrl = retUrl;
		this.content = SpringUtils.getMessage(content, args);
	}
	 ...
	 * @return 成功消息
	 */
	public static Message successReload(String content, Object... args) {
		Message message = new Message(Message.Type.success, content, args);
		message.setRetUrl("reload");
		return message;
	}
	...
	public static Message errorMsg(String content) {
