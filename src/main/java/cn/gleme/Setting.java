...
public class Setting implements Serializable {
	...
	/** 默认合伙人头像 */
	private String defailtPartnerImg;
	
	/** 默认合伙人名称 */
	private String defailtPartnerName;
	
	/** 默认副标题 */
	private String defailtSubtitle;
	...
	public void setWchatAppId(String wchatAppId) {
		this.wchatAppId = wchatAppId;
	}

	public String getWchatAppSecret() {
		return wchatAppSecret;
	}

	public void setWchatAppSecret(String wchatAppSecret) {
		this.wchatAppSecret = wchatAppSecret;
	}
	...
	public String getDefailtPartnerImg() {
		return defailtPartnerImg;
	}

	public void setDefailtPartnerImg(String defailtPartnerImg) {
		this.defailtPartnerImg = defailtPartnerImg;
	}

	public String getDefailtPartnerName() {
		return defailtPartnerName;
	}

	public void setDefailtPartnerName(String defailtPartnerName) {
		this.defailtPartnerName = defailtPartnerName;
	}
	...
	public String getDefailtSubtitle() {
		return defailtSubtitle;
	}

	public void setDefailtSubtitle(String defailtSubtitle) {
		this.defailtSubtitle = defailtSubtitle;
	}
